...
# Functions
source("~/Dropbox/Research/Stats Stuff/R Generic Scripts & Functions/identify_outliers_histogram.R")
source("~/Dropbox/Research/Stats Stuff/R Generic Scripts & Functions/winsorize.R")
source("~/Dropbox/Research/Stats Stuff/R Generic Scripts & Functions/remove_outliers.R")
...
setwd(
  "~/Dropbox/Research/Vanderbilt/Ecology of Early Life/Methods Manuscript/Data/Family One"
)
...
setwd(
  "~/Dropbox/Research/Vanderbilt/Ecology of Early Life/Methods Manuscript/Data/Family Two"
)

BothDays4F <- read.table("prox/Day 2/smoothedav4F.log") %>%
  bind_rows(read.table("prox/Day 3/smoothedav4F.log")) %>%
  mutate(
...
BothDays50 <- read.table("prox/Day 2/smoothedav50.log") %>%
  bind_rows(read.table("prox/Day 3/smoothedav50.log")) %>%
  mutate(
    V2 = str_remove(V2, "c0:98:e5:42:00:"),
    V2 = paste("50_", V2),
    Day = case_when(
...
BothDays51 <- read.table("prox/Day 2/smoothedav51.log") %>%
  bind_rows(read.table("prox/Day 3/smoothedav51.log")) %>%
  mutate(
    V2 = str_remove(V2, "c0:98:e5:42:00:"),
    V2 = paste("51_", V2),
    Day = case_when(
...
F2DaughterDay1Lena <-
  read_csv("lena/20210321_192524_029763.csv") %>% 
...
F2DaughterDay2Lena <-
  read_csv("lena/20210321_202437_029783.csv") %>% 
  select(Clock_Time_TZAdj,
         AWC,
         Turn_Count,
         Child_Voc_Count,
