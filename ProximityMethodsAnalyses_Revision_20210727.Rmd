...
setwd(
  "~/Documents/GitHub/tottag_methods"
)
...
Day1Plots <- (F1p1 + F1p2 + F2p1) /
  (F1p3 + F1p4 + F2p2) +
  plot_annotation(title = "Recording Day 1")
Day1Plots

ggsave(
  "Day1PlotsRevScaleC20_727.png",
  plot = Day1Plots,
  dpi = 300,
  height = 4.75,
  width = 7.5
...
Day2Plots <- (F1p5 + F1p6 + F2p3) /
  (F1p7 + F1p8 + F2p4)  +
  plot_annotation(title = "Recording Day 2")
Day2Plots

ggsave(
  "Day2PlotsRevScaleC20_727.png",
  plot = Day2Plots,
  dpi = 300,
  height = 4.75,
  width = 7.5
...
setwd("~/Documents/GitHub/tottag_methods/LENA files")

F1SonDay1Lena <-
  read_csv("F1S_Day 1.csv") %>%
...
SuppPlotsD1 <- (pS1a + pS2a + pS3a)  +
  plot_annotation(title = "Recording Day 1")
SuppPlotsD2 <- (pS1b + pS2b + pS3b) +
  plot_annotation(title = "Recording Day 2")
ggsave("SuppPlotsC20_D1727.png",
       plot = SuppPlotsD1,
       dpi = 300,
       width = 7,
       height = 2.5)
ggsave("SuppPlotsC20_D2727.png",
       plot = SuppPlotsD2,
       dpi = 300,
       width = 7,
       height = 2.5)
